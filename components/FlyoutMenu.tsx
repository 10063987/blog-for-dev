...
const FlyoutMenu = ({ links = [], show = false, containerRef, onClose = () => { }, }: FlyoutMenuProps) => {
    ...
    useEffect(() => {
        ...
        if (show) {
            window.addEventListener('mousedown', (e) => mouseDownListener(e));
            window.addEventListener('keydown', (e) => keyDownListener(e));
        }

        return () => {
            window.removeEventListener('mousedown', (e) => mouseDownListener(e));
